                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    @auth
                        ...
                        <a href="{{ route('admin.dashboard') }}"
                            class="flex items-center space-x-1 px-4 py-2 rounded-lg text-amber-600 hover:text-amber-700 hover:bg-amber-50 font-semibold transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.word-lists.index') }}"
                            class="flex items-center space-x-1 px-4 py-2 rounded-lg text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 font-semibold transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="md:hidden" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-transition
                        ...
                        @auth
                            @if(Auth::user()->is_admin)
                            <a href="{{ route('admin.dashboard') }}"
                                class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-amber-600 hover:bg-amber-50 font-semibold">
                            ...
                            @elseif(Auth::user()->is_teacher)
                            <a href="{{ route('admin.word-lists.index') }}"
                                class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-emerald-600 hover:bg-emerald-50 font-semibold">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                                </svg>
