<x-app-layout>
    <x-slot name="title">Addition & Subtraction</x-slot>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="mb-8">
            <div class="flex items-center space-x-3 mb-3">
                ...
                <span class="text-sm font-medium text-slate-600">Addition & Subtraction</span>
            </div>
        </div>

        @livewire('addition-subtraction-game')
    </div>
</x-app-layout>
